 ...
 */
public class ViewManutencaoProfessor extends javax.swing.JFrame {


    ViewConsultaProfessor cons = new ViewConsultaProfessor(this, true);

    ControllerProfessorDB professordb = new ControllerProfessorDB();

    public ViewManutencaoProfessor() {
        initComponents();
...
// Seta os dados da tela no modelo de produto
        ...
        if(validaCamposVazios(auxCodigo, auxnome)){
            ...
            ModelProfessor professor = new ModelProfessor(codigo, auxnome);
            
            ModelProfessor professorBanco = professordb.getProfessor(codigo);
            if (professorBanco.getCodigo() > 0) {
                if(professordb.gravarAlteracaoProfessor(professor)){
                    ...
                    JOptionPane.showMessageDialog(null, "Erro ao gravar alteração do professor!");
                }
            } else {
                if(professordb.gravarInsercaoProfessor(professor)){
...
//        }
    ...
    int codigoProfessor = Integer.parseInt(edtCodigo.getText());


            if (professordb.excluirProfessor(codigoProfessor)) {
    ...
    private void edtCodigoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_edtCodigoKeyPressed
        if ((evt.getKeyCode() == KeyEvent.VK_ENTER) || (evt.getKeyCode() == KeyEvent.VK_TAB)) {
            if (edtCodigo.getText().equals("")) {
                ...
                edtCodigo.setText(String.valueOf(professordb.getUltimoCodigo("tbprofessor", "codigo")));
                ...
                ModelProfessor professorBanco = new ModelProfessor();
                professorBanco = professordb.getProfessor(codigo);
                if (professorBanco.getCodigo() > 0) {
                    edtNome.setText(professorBanco.getNome());
...
//        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewManutencaoProfessor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewManutencaoProfessor().setVisible(true);
            }
        });
    }
    ...
    private boolean validaCamposVazios(String auxCodigo, String auxnome) {
       if(auxCodigo.equals("")){
            return false;
        }
