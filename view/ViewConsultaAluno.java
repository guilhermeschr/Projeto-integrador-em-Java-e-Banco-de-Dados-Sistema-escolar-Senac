 ...
 */
public class ViewConsultaAluno extends javax.swing.JDialog {
    ...
    public ViewConsultaAluno(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
...
//            }            
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consulta de Alunos");
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 640, 340));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewConsultaAluno.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewConsultaAluno dialog = new ViewConsultaAluno(new javax.swing.JFrame(), true);
