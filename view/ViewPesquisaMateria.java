...
import controller.ControllerMateriaDB;
...
public class ViewPesquisaMateria extends javax.swing.JDialog {
    ...
    ControllerMateriaDB materiadb = new ControllerMateriaDB();
    ...
    public void listaTodosRegistros() {                
        ...
        ArrayList<Modelmateria> materias = materiadb.getTodos();
        
        // Percorre a lista de pessoas recebidas e adiciona na tabela da tela
        //   tipo        apelido     arrayList de pessoas
        for (Modelmateria auxMateria : materias) {
//            if(auxPessoa.getCodigo() > 1){
                modelo.addRow(new Object[]{
                    auxMateria.getCodigo(),
                    auxMateria.getCodigo() + " - "+ auxMateria.getNome(),
                    auxMateria.getNome()
                });                
//            }            
        }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consulta de matéria");
